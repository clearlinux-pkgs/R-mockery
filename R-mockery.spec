...
Version  : 0.4.0
Release  : 5
URL      : https://cran.r-project.org/src/contrib/mockery_0.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mockery_0.4.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510235942
